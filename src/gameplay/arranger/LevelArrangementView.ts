    ...
    <div class="arranger-layout">
      <aside class="arranger-panel arranger-groups-panel" aria-labelledby="arranger-groups-title">
        <header>
          ...
          <div class="arranger-group-actions"><button id="arranger-auto-layout" type="button" disabled>自动排布</button><button id="arranger-copy-groups" type="button" disabled>复制当前配置</button><button id="arranger-batch-calculate" type="button" disabled>计算配置</button><button id="arranger-excel-calculate" type="button">计算 Excel</button><input id="arranger-excel-calculate-file" type="file" accept=".xlsx" hidden><button id="arranger-copy-level-data" type="button" disabled>导出三模式关卡数据</button><button id="arranger-add-group" type="button">＋ 新增</button></div>
        </header>
